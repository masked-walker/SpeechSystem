  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '智能推荐', icon: 'magic-stick' }
      },
      {
        path: '/face-recognition',
        name: 'FaceRecognition',
        component: () => import('@/components/FaceRecognition.vue') // 替换为您的人脸识别组件
      },
      {
        path: '/speech-recognition',
        name: 'SpeechRecognition',
        component: () => import('@/components/SpeechRecognition.vue') // 替换为您的语音识别组件
      }
    ]
  },
  {
